...
selecciones del árbol Ikigai de Fase 1 en curso
(tools/selecciones_estructuradas.py). Pensado para
...
from tools.selecciones_estructuradas import borrar_selecciones_estructuradas  # noqa: E402

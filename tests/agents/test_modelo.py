"""Prueba que agents/_modelo.py arme el BedrockModel de los subagentes
con o sin guardrail según GUARDRAIL_ID -- sin llamar a Bedrock de verdad
...
vez al importar el módulo, igual que MODEL_ID_SUBAGENTE/REGION.

`crear_modelo_orquestador` (y sus tests) se eliminaron el 14/09/2026:
quedó sin ningún caller real tras el revert del orquestador agéntico --
ver docstring de agents/_modelo.py."""

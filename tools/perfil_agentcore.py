...
def leer_nombre_usuario(usuario_id: str) -> str | None:
    # max_results alto + en_orden_cronologico() -- ver el bug real
    # documentado en tools/ficha_agentcore.py::en_orden_cronologico. Acá
    # nunca se notó porque el nombre se guarda una sola vez, pero es el
    # mismo riesgo si algún día se re-guarda más de una vez (ej.
